**Early preview** — [feedback welcome](https://github.com/phoenixra17/navette/issues/new/choose). The apps' interface is in French for now.

### Mac (macOS 14+, Apple Silicon or Intel)

1. Download `Navette-…-mac.zip`, unzip it and move **Navette** to *Applications*.
2. Open it. macOS blocks it the first time because it is not signed by Apple: go to
   **System Settings › Privacy & Security**, scroll down and click **Open Anyway**.
   (Or, in Terminal: `xattr -dr com.apple.quarantine /Applications/Navette.app`.)
3. When asked for the server address, enter the public test relay
   `https://navette.yourpediatricsurgeon.com` — or your own relay.
...
Optional features (automatic sending from the phone, instant hotspot): see the
[README](https://github.com/phoenixra17/navette#install).
